...
export const transcriptData = [
    ...
    { start: 18, text: "I'm the director of products for Star Witness at Signal Scape.  " },
    
    {start:22, text:"And I'm going to be giving you a preview of the audio pickup for the star witness. "},
    { start: 27, text: "Interviewer. Uh, interview room recording system. Uh," },
    ...
    { start: 40, text: "And so what I'm going to do is I'm going to read through a testimonial from one of our customers. " },
    { start: 44, text: "And as I read that, I'll, um, become quieter and quieter  " },
    
    { start: 49, text: "and get to a low whisper so you'll be able to see how the star witness interviewer picks up audio. " },
      { start: 55, text: "Um, at those low levels, uh," },
    { start: 57, text: "one thing to keep in mind is that as you watch the video,  " },


    
     { start: 62, text: "um, you might want to listen with headphones such that you get all that sound reproduced and you can hear, " },
      { start: 70, text: "um, the low whispers sometimes like a laptop, " },
       { start: 72, text: "speakers or something like that might have a difficult time reproducing that sound for you to be able to hear, " },
    { start: 77, text: "but headphones will definitely, um, give you a better, uh, listening experience for the video." },
    ...
    { start: 83, text: "And from from there, I'm going to go ahead and start reading through this testimonial. Um, " },
    ...
    { start: 104, text: "The first was a computer based interview room which required codecs, special player, and a lot of troubled software. " },
    ...
    { start: 175, text: "The burning tool is ultra easy. Simply put, the system is. To record it and then press the same button to stop." },
    { start: 184, text: " Once your interview is complete, click on the DVD and click. It's that easy. I would highly recommend this product. Any law enforcement agency. Not only for the ease of the system, but the excellent customer service that we've received throughout the years.  " },
